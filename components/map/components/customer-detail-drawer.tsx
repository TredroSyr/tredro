...
import { CustomerListItem, WORK_DAYS_LABELS, Shop, distanceKm } from "../lib/tour-data";
...
export function CustomerDetailDrawer({
  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange}>
      <DrawerContent
        className={`${overlayZ} mt-0 flex h-[75%] flex-col rounded-t-[1.75rem] border-t border-glass-border bg-card/95 shadow-sheet backdrop-blur-xl ${panelWidthClass} md:rounded-b-[1.75rem]`}
