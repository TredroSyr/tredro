...
/** Row shape used by the shop list / detail drawers — includes customers without a map location. */
...
export const WORK_DAYS_LABELS: Record<DayKey, string> = Object.fromEntries(
  DAYS.map((d) => [d.key, d.label]),
) as Record<DayKey, string>;

export const INITIAL_CUSTOMER_ITEMS: CustomerListItem[] = [
  ...INITIAL_SHOPS.map((s) => ({
    id: s.id,
    name: s.name,
    phone: s.phone,
