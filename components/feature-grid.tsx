  ...
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto px-2 sm:px-4">
        ...
        <div className="relative w-full overflow-x-auto no-scrollbar rounded-3xl border border-border shadow-xs bg-card">
          {/* Left Edge Fade & Blur Mask */}
          <div className="pointer-events-none absolute inset-y-0 left-0 w-16 sm:w-32 md:w-44 bg-gradient-to-r from-background via-background/80 to-transparent backdrop-blur-[2px] z-20 transition-opacity" />

          {/* Right Edge Fade & Blur Mask */}
          <div className="pointer-events-none absolute inset-y-0 right-0 w-16 sm:w-32 md:w-44 bg-gradient-to-l from-background via-background/80 to-transparent backdrop-blur-[2px] z-20 transition-opacity" />
          ...
          <div className="min-w-[1100px] grid grid-cols-10 border-l border-t border-border">
                  ...
                  <Card className="rounded-xl border-border shadow-xs p-2.5 space-y-1.5">
                    ...
                    <div className="flex items-center justify-between text-[10px] bg-muted px-2 py-1 rounded-md">
                      <span className="font-bold text-foreground flex items-center gap-1">
                        <IconRenderer name="tick_outlined" className="w-3 h-3 text-primary" />
                ...
                <div className="w-full max-w-[240px] space-y-2">
                  <Card className="rounded-xl border-border shadow-xs p-2.5 space-y-2">
                    ...
                    <div className="flex items-center gap-1.5 pt-1 border-t border-border">
                      ...
                      >
                        <IconRenderer name="cart_outlined" className="w-2.5 h-2.5" />
                        طلب جديد
                      </Badge>
                      <Badge
                        variant="outline"
                      ...
                      >
                        <IconRenderer name="whatsapp_outlined" className="w-2.5 h-2.5" />
                        واتساب
                      </Badge>
                    </div>
                  </Card>
            ...
            {/* ================= ROW 7 (Empty fading bottom row for infinite grid aesthetic) ================= */}
            {Array.from({ length: 10 }).map((_, idx) => (
              <div
                key={idx}
                className="h-12 border-r border-b border-border bg-gradient-to-b from-background to-muted/50"
              />
            ))}
          </div>
        </div>
